...
with DAG(
    ...
    rct_simulate_cpt.doc = """Simulation from a cpt file."""
    ...
    grompp_cpt = ResourceRCTOperator(
        task_id="grompp",
        executor_config={
            "mpi_ranks": 1,
            "cpus_per_task": 1,
...
with DAG(
...
) as rct_simulate_no_cpt:
    rct_simulate_no_cpt.doc = """Simulation without a cpt file."""
    ...
    grompp_no_cpt = ResourceRCTOperator(
        task_id="grompp",
        executor_config={
            "mpi_ranks": 1,
            "cpus_per_task": 1,
    ...
    mdrun_no_cpt = ResourceRCTOperator(
        task_id="mdrun",
        executor_config={
            "mpi_ranks": 4,
            "cpus_per_task": 2,
