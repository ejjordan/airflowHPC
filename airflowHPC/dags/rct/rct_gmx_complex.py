...
with DAG(
    ...
    grompp_batch_1 = ResourceRCTOperator(
    ...
    mdrun_batch_1 = ResourceRCTOperator(
    ...
    grompp_batch_2 = ResourceRCTOperator(
    ...
    mdrun_batch_2 = ResourceRCTOperator.partial(
