...
with DAG(
    ...
    npt_equil.doc = """Generic gromacs setup."""
    ...
    mdp_npt = update_write_mdp_json_as_mdp_from_file.override(task_id="mdp_npt_update").partial(
        mdp_json_file_path=mdp_json_npt
